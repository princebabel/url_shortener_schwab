...
1. An engineer opens Copilot Chat and selects the Task Router agent from [../../.github/agents/coding-assistant-task-router.agent.md](../../.github/agents/coding-assistant-task-router.agent.md) when they need a quick triage decision before implementation. 2. If the work is classified as greenfield, the engineer can switch to the Greenfield Engineer agent from [../../.github/agents/coding-assistant-greenfield.agent.md](../../.github/agents/coding-assistant-greenfield.agent.md). 3. If the work is classified as brownfield, the engineer can switch to the Brownfield Engineer agent from [../../.github/agents/coding-assistant-brownfield.agent.md](../../.github/agents/coding-assistant-brownfield.agent.md). 4. While the engineer edits files such as controllers or services, the matching instructions from [../../.github/instructions/controller-conventions.instructions.md](../../.github/instructions/controller-conventions.instructions.md) or [../../.github/instructions/service-conventions.instructions.md](../../.github/instructions/service-conventions.instructions.md) apply automatically in the background. 5. If the work is still unclear, the engineer can paste [../../.github/prompts/01-requirement-analysis.md](../../.github/prompts/01-requirement-analysis.md) to start a requirement review. 6. As the conversation progresses, the agent may reach for a skill such as [../../.github/skills/requirement-analysis/SKILL.md](../../.github/skills/requirement-analysis/SKILL.md) or [../../.github/skills/spring-boot-scaffolding/SKILL.md](../../.github/skills/spring-boot-scaffolding/SKILL.md) because the task matches its purpose.
