...
| AI-007 | Move the GitHub configuration guide into the docs area | The existing GitHub Copilot configuration guide was preserved and relocated into the documentation structure for easier discovery | Accepted with engineer review | The guide belongs with the rest of the project’s governance and workflow documentation, rather than being isolated in the repository’s hidden config folder. |
