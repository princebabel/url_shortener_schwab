...
| Dependency vulnerability scan | Not yet configured | N/A | [pom.xml](../../pom.xml) | No dependency-check or similar vulnerability-scan plugin was found in the build configuration. |
